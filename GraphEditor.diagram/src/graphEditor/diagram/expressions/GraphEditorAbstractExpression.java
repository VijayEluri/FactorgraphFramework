 ...
 * @generated
 */
public abstract class GraphEditorAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = graphEditor.diagram.part.GraphEditorDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected GraphEditorAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
