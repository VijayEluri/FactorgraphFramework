...
public class GraphCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = graphEditor.diagram.part.GraphEditorDiagramUpdater
				.getGraph_1000SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
			result.add(((graphEditor.diagram.part.GraphEditorNodeDescriptor) it
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize
					.add(graphEditor.GraphEditorPackage.eINSTANCE
							.getGraph_Nodes());
		}
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = graphEditor.diagram.part.GraphEditorVisualIDRegistry
			...
			for (Iterator LinkDescriptorsIterator = linkDescriptors.iterator(); LinkDescriptorsIterator
					.hasNext();) {
				graphEditor.diagram.part.GraphEditorLinkDescriptor nextLinkDescriptor = (graphEditor.diagram.part.GraphEditorLinkDescriptor) LinkDescriptorsIterator
						.next();
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case graphEditor.diagram.edit.parts.MessageEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(graphEditor.diagram.part.GraphEditorDiagramUpdater
								.getMessage_4002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final graphEditor.diagram.part.GraphEditorLinkDescriptor nextLinkDescriptor = (graphEditor.diagram.part.GraphEditorLinkDescriptor) linkDescriptorsIterator
					.next();
