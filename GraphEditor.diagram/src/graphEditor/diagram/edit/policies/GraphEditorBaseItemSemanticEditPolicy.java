 ...
 * @generated
 */
public class GraphEditorBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (elementType != null) {
			if (semanticCommand != null) {
				...
				completedRequest
						.setParameter(
								graphEditor.diagram.edit.helpers.GraphEditorBaseEditHelper.EDIT_POLICY_COMMAND,
								command);
			}
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateMessage_4002(
				graphEditor.Graph container, graphEditor.Node source,
				graphEditor.Node target) {
			return canExistMessage_4002(container, source, target);
		}
