	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case graphEditor.diagram.edit.parts.EdgeEditPart.VISUAL_ID:
				return new graphEditor.diagram.edit.parts.EdgeEditPart(view);

			case graphEditor.diagram.edit.parts.MessageEditPart.VISUAL_ID:
				return new graphEditor.diagram.edit.parts.MessageEditPart(view);

			case graphEditor.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID:
				return new graphEditor.diagram.edit.parts.WrappingLabel3EditPart(
						view);
			}
		}
