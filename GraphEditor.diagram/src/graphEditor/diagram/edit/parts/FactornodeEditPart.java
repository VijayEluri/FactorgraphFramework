 ...
 * @generated
 */
public class FactornodeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FactornodeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new graphEditor.diagram.edit.policies.FactornodeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof graphEditor.diagram.edit.parts.VariablenodeNameEditPart) {
			((graphEditor.diagram.edit.parts.VariablenodeNameEditPart) childEditPart)
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(graphEditor.diagram.part.GraphEditorVisualIDRegistry
				.getType(graphEditor.diagram.edit.parts.VariablenodeNameEditPart.VISUAL_ID));
	}
