...
public class RengineAction implements IWorkbenchWindowActionDelegate {
	...
	public void run(IAction action){
		...
		TestGraphEditor loader = new TestGraphEditor();
		Graph graph=loader.load("\\Dokumente und Einstellungen\\alex\\Desktop\\runtime-EclipseApplication\\test\\default.grapheditor");
