...
/**
 * This is the item provider adapter for a {@link graphEditor.Graph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GraphItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GraphEditorPackage.Literals.GRAPH__NODES);
			childrenFeatures.add(GraphEditorPackage.Literals.GRAPH__EDGES);
			childrenFeatures.add(GraphEditorPackage.Literals.GRAPH__MESSAGES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GraphEditorPackage.Literals.GRAPH__NODES,
				 GraphEditorFactory.eINSTANCE.createFactornode()));

		newChildDescriptors.add
			(createChildParameter
				(GraphEditorPackage.Literals.GRAPH__NODES,
				 GraphEditorFactory.eINSTANCE.createVariablenode()));

		newChildDescriptors.add
			(createChildParameter
				(GraphEditorPackage.Literals.GRAPH__EDGES,
				 GraphEditorFactory.eINSTANCE.createEdge()));

		newChildDescriptors.add
			(createChildParameter
				(GraphEditorPackage.Literals.GRAPH__MESSAGES,
				 GraphEditorFactory.eINSTANCE.createMessage()));
	}
