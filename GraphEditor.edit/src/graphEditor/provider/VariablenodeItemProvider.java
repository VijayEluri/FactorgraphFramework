...
/**
 * This is the item provider adapter for a {@link graphEditor.Variablenode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariablenodeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variablenode_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variablenode_type_feature", "_UI_Variablenode_type"),
				 GraphEditorPackage.Literals.VARIABLENODE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addValuesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Variablenode_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Variablenode_values_feature", "_UI_Variablenode_type"),
				 GraphEditorPackage.Literals.VARIABLENODE__VALUES,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Variablenode)object).getName();
